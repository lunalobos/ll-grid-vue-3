<template>
	<div class="inline-block p-1">
		<div class="p-1 flex flex-row justify-center text-center">
			<button
        ...
        <div
			...
			>
				...
				<div
					class="border border-gray-300 overflow-y-auto max-h-48 rounded-lg p-1 bg-gray-50 mt-1"
				>
					<ul>
						<li
...
<script setup>
	...
	const values = computed(() => {
		if (filterInput.value && filterInput.value !== "") {
			return header.value.values.filteredValues((value) =>
				like(value, filterInput.value)
			);
		} else {
