    ...
    <div class="grid grid-cols-12 p-1">
        <div class="relative inline-block col-span-1 p-1">
            <button v-if="header.type !== 'button'" @click="togleDropdown()"
                class="cursor-pointer bg-gray-600 p-2 hover:bg-gray-500 rounded-lg ">
                <component :is="filled ? FilledFilter : Filter"> </component>
            </button>

            <div v-show="showDropdown" class="block absolute bg-gray-900 shadow-lg min-w-42 z-10 rounded-lg p-2">
                ...
                <form class="max-w-md mx-auto" @submit.prevent="() => { }">
                    <div class="relative">
                        <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                            <svg class="w-4 h-4 text-gray-9500 dark:text-gray-400" aria-hidden="true"
                ...
                <div class="border border-gray-700 overflow-y-auto max-h-48 rounded-lg p-1 bg-gray-950 mt-1">
                    <ul>
                ...
                <div v-show="selectedValues.length > 0" class="mt-1 flex justify-center items-center">
                    <button class="flex flex-row rounded-lg bg-gray-600 hover:bg-gray-9500 cursor-pointer p-2 text-sm "
                        @click="applyFilter()">
